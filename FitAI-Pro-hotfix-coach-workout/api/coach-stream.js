...
**Gras** pour les points clés. Listes avec "- ". Séance = Échauffement/Corps/Retour au calme avec séries×reps×repos. Court si question simple, complet si plan. Termine toujours par une phrase complète avec une ponctuation finale.`;
